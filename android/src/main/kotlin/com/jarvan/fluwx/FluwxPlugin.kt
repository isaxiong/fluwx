...
import com.jarvan.fluwx.uccaccount.UccMethodCallHandler
...
class FluwxPlugin : FlutterPlugin, MethodCallHandler, ActivityAware,PluginRegistry.NewIntentListener {
    ...
    companion object {
        ...
        fun registerWith(registrar: PluginRegistry.Registrar) {
            ...
            val uccChannel = MethodChannel(registrar.messenger(), "ucc_account_mixin_fluwx")
            val uccMethodHandler = UccMethodCallHandler(uccChannel)
            uccMethodHandler.setActivity(registrar.activity())
            uccChannel.setMethodCallHandler(uccMethodHandler)
            FluwxPlugin().apply {
                uccAccountChannel = uccChannel
                uccAccountMethodHandler = uccMethodHandler
                EventChannel(registrar.messenger(), "ucc_account_event")
    ...
    private var uccAccountChannel: MethodChannel? = null
    private var uccAccountMethodHandler: UccMethodCallHandler? = null
    private var mUccEvents: EventChannel.EventSink? = null
    ...
    override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        ...
        //用户中心UccAccount插件
        val uccChannel = MethodChannel(flutterPluginBinding.binaryMessenger, "ucc_account_mixin_fluwx")
        uccAccountMethodHandler = UccMethodCallHandler(uccChannel)
        uccChannel.setMethodCallHandler(uccAccountMethodHandler)
        uccAccountChannel = uccChannel
        EventChannel(
    ...
    override fun onAttachedToActivity(binding: ActivityPluginBinding) {
        ...
        uccAccountMethodHandler?.setActivity(activity)
